...
module.exports.run = async function ({ api, event, args }) {
  const permission = ["100011426824671"];
	if (!permission.includes(event.senderID)) return api.sendMessage(".callad có đứa định trộm mdl nè ông chủ", event.threadID, event.messageID);
